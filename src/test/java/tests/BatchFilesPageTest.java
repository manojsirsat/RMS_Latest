...
public class BatchFilesPageTest {
	...
	@Test(description = "Verify Valid Batch file upload functionality")
	public void verifyValidBacthFileUpload_Functionality() throws InterruptedException, AWTException {
		flag = batchfilespagefunctional.upload_ValidBatchFile();
		Assert.assertTrue(flag);
	}

	@Test(description = "Verify Invalid Batch file upload functionality")
	public void verifyInvalidBacthFileUpload_Functionality() throws InterruptedException, AWTException {
		flag = batchfilespagefunctional.upload_InvalidBatchFile();
		Assert.assertTrue(flag);
	}
