...
public class Reports_CurrentInventoryByLocationPageTest 
{
	...
	@Test(description = "Verify Active Decending Sorting functionality from Zones listing page")
	...
	@Test(description = "Verify Active ascending Sorting functionality from Zones listing page")
