...
public class RecoveriesByComponentTest 
{
	...
	@Test(description = "Verify Loc Conf Avail Recov Val Decending Sorting functionality from Zones listing page")
	...
	@Test(description = "Verify Loc Conf Avail Recov Val ascending Sorting functionality from Zones listing page")
	...
	@Test(description = "Verify Current Status Decending Sorting functionality from Zones listing page")
	...
	@Test(description = "Verify Current Status ascending Sorting functionality from Zones listing page")
