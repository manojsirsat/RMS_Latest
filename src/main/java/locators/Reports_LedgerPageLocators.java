...
public class Reports_LedgerPageLocators {
	...
	/** XPATH */
	public static final String REPORTS_LEDGERPAGE_HEADING = "//div[text()='Inventory Ledger']";
	...
	/** XPATH */
	public static final String STRING_WOID_COLDATA = "//table/tbody/tr/td[4]";
	/** XPATH */
	public static final String STRING_WOID_COLHEADER = "(//th[contains(.,'WO ID')])[1]";
	...
	/** XPATH */
	public static final String STRING_LOCNAME_COLDATA = "//table/tbody/tr/td[7]";
	/** XPATH */
	...
	/** XPATH */
	public static final String STRING_LOCCODE_COLDATA = "//table/tbody/tr/td[8]";
	/** XPATH */
	...
	/** XPATH */
	public static final String STRING_SKU_COLDATA = "//table/tbody/tr/td[9]";
	/** XPATH */
	...
	/** XPATH */
	public static final String STRING_SKU1_COLHEADER = "(//th[contains(.,'SKU#')])[1]";
	...
	/** XPATH */
	public static final String STRING_STAGE_COLHEADER = "(//th[contains(.,'Stage')])[1]";
	...
	/** XPATH */
	public static final String STRING_QTY_COLDATA = "//table/tbody/tr/td[12]";
	/** XPATH */
	public static final String STRING_QTY_COLHEADER = "(//th[contains(.,'Qty')])[1]";
	...
	/** XPATH */
	public static final String STRING_INVBEFORE_COLDATA = "//table/tbody/tr/td[13]";
	/** XPATH */
	public static final String STRING_INVBEFORE_COLHEADER = "(//th[contains(.,'Inv Before')])[1]";
	...
	/** XPATH */
	public static final String STRING_INVAFTER_COLDATA = "//table/tbody/tr/td[14]";
	/** XPATH */
	public static final String STRING_INVAFTER_COLHEADER = "(//th[contains(.,'Inv After')])[1]";
	...
	/** XPATH */
	public static final String STRING_TXTYPE_COLDATA = "//table/tbody/tr/td[15]";
	/** XPATH */
	public static final String STRING_TXTYPE_COLHEADER = "(//th[contains(.,'Tx Type')])[1]";
	...
	/** XPATH */
	public static final String STRING_WOTYPE_COLDATA = "//table/tbody/tr/td[16]";
	/** XPATH */
	public static final String STRING_WOTYPE_COLHEADER = "(//th[contains(.,'WO Type')])[1]";
	...
	/** XPATH */
	public static final String STRING_ACTION_COLDATA = "//table/tbody/tr/td[17]";
	/** XPATH */
	public static final String STRING_ACTION_COLHEADER = "//th[contains(.,'Action')]";
	...
	/** XPATH */
	public static final String STRING_LOCTYPE_COLDATA = "//table/tbody/tr/td[18]";
	/** XPATH */
	...
	/** XPATH */
	public static final String STRING_ACCOUNT_COLDATA = "//table/tbody/tr/td[19]";
	/** XPATH */
	...
	/** XPATH */
	public static final String STRING_USER_COLDATA = "//table/tbody/tr/td[20]";
	/** XPATH */
	public static final String STRING_USER_COLHEADER = "(//th[contains(.,'User')])[1]";
