...
public class Reports_ArchivePageLocators {
	...
	/** XPATH */
	public static final String REPORTS_ARCHIVEPAGE_HEADING = "//div[text()='Reports']";
	...
	/** XPATH */
	public static final String STRING_REPORT_COLDATA = "//table/tbody/tr/td[1]";
	/** XPATH */
	public static final String STRING_REPORT_COLHEADER = "(//th[contains(.,'Report #')])[1]";
	...
	/** XPATH */
	public static final String STRING_NAME_COLHEADER = "(//th[contains(.,'Name')])[1]";
	...
	/** XPATH */
	public static final String STRING_OWNER_COLDATA = "//table/tbody/tr/td[5]";
	/** XPATH */
	public static final String STRING_OWNER_COLHEADER = "(//th[contains(.,'Owner')])[1]";
	...
	/** XPATH */
	public static final String STRING_REQUESTEDBY_COLDATA = "//table/tbody/tr/td[6]";
	/** XPATH */
	public static final String STRING_REQUESTEDBY_COLHEADER = "(//th[contains(.,'Requested By')])[1]";
	...
	/** XPATH */
	public static final String STRING_REPORTREQUESTED_COLDATA = "//table/tbody/tr/td[7]";
	/** XPATH */
	public static final String STRING_REPORTREQUESTED_COLHEADER = "(//th[contains(.,'Report Requested')])[1]";
