...
public class CreateOrderPageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Create order page
	...
	public boolean navigate_CreateOrderPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.CREATEORDER_PAGE, ElementType.Xpath,
					CreateOrderPageLocators.CREATEORDER_PAGE_HEADING, ElementType.Xpath);
		}
		return flag;
	}
	...
	/**
	 * @author
	 * @return flag This method is used to select the general information details
	 * @throws InterruptedException
	 */
...
//				webDB.getDriver().findElement(By.xpath(CreateOrderPageLocators.ACCOUNT_DRP_OPTIONS_LIST+"["+oneoption+"]")).click(); //Select for dynamic account selection
				webDB.getDriver()
						.findElement(By.xpath(CreateOrderPageLocators.ACCOUNT_DRP_OPTIONS_LIST + "[" + 1 + "]"))
						.click();
				...
				if (flag) {
					...
					webDB.getDriver()
							.findElement(
									By.xpath(CreateOrderPageLocators.PROGRAM_DRP_OPTIONS_LIST + "[" + oneprogram + "]"))
							.click();
	...
	/**
	 * @author
	 * @return flag This method is used to set the Transit details
	 * @throws InterruptedException
	 */
	public boolean set_Transit_Details() throws InterruptedException {
		...
		if (flag) {
			...
			webDB.getDriver()
					.findElement(
							By.xpath(CreateOrderPageLocators.ORDERTYPE_DRP_OPTIONS_LIST + "[" + oneordertype + "]"))
					.click();
			...
			if (flag) {
				...
				Thread.sleep(1000);
				int totalfromlocoptions = webDB.getDriver()
						.findElements(By.xpath(CreateOrderPageLocators.FROM_LOC_DRP_OPTIONS_LIST)).size();
				onefromloc = faker.number().numberBetween(1, totalfromlocoptions - 1);
				webDB.getDriver()
						.findElement(
								By.xpath(CreateOrderPageLocators.FROM_LOC_DRP_OPTIONS_LIST + "[" + onefromloc + "]"))
						.click();
					...
					if (onefromloc == onetoloc) {
						...
						webDB.getDriver()
								.findElement(By.xpath(
										CreateOrderPageLocators.TO_LOC_DRP_OPTIONS_LIST + "[" + finalto_location + "]"))
								.click();
						Thread.sleep(2000);
						...
						webDB.getDriver()
								.findElement(By
										.xpath(CreateOrderPageLocators.TO_LOC_DRP_OPTIONS_LIST + "[" + onetoloc + "]"))
								.click();
						Thread.sleep(2000);
						log.logging("info", "Selected To location");
						flag = true;
						...
						if (flag) {
							...
							if (flag) {
								webDB.clickAnElement(CreateOrderPageLocators.DELIVERY_WINDOW_STARTDATE_CALENDER,
										ElementType.Id);
								Thread.sleep(1000);
								webDB.clickAnElement(CreateOrderPageLocators.DELIVERY_WINDOW_STARTDATE_TODAY,
										ElementType.Xpath);
								Thread.sleep(1000);
								webDB.clickAnElement(CreateOrderPageLocators.NEXTHOUR_INCREMENT_BTN, ElementType.Xpath);
								Thread.sleep(1000);
...
//									Thread.sleep(1000);
	...
	/**
	 * @author
	 * @return flag This method is used to set the Transit details for multiple
	 *         orders
	 * @throws InterruptedException
	 */
...
//									Thread.sleep(1000);
	...
	/**
	 * @author
	 * @return flag This method is used to set Items to Transit
	 * @throws InterruptedException
	 */
	...
	/**
	 * @author
	 * @return flag This method is used to click on submit or create order button
	 * @throws InterruptedException
	 */
...
//			log.logging("info", "The order number is "+ordernumberfromorderdetailspage);
	...
	/**
	 * @author
	 * @return flag This method is used to verify the complete create order flow
	 * @throws InterruptedException
	 */
	...
	/**
	 * @author
	 * @return flag This method is used to verify the complete multiple order flow
	 * @throws InterruptedException
	 */
