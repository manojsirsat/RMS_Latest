...
public class Reports_CurrentInventoryByLocationPageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Reports Current inventory by
	...
	public boolean navigate_Reports_CurrentInventoryByLocationListingPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(
					CommonFunctionsLocators.REPORTS_CURRENTINVENTORYBYLOCATIONPAGE_LEFTNAV, ElementType.Xpath,
					Reports_CurrentInventoryByLocationPageLocators.REPORTS_CURRENTINVENTORYBYLOCATIONPAGE_HEADING,
					ElementType.Xpath);
		}
		return flag;
	}
	...
	public boolean AccountName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_ACCOUNTNAME_COLDATA);
		return flag;
	}
	...
	public boolean AccountCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_ACCOUNTCODE_COLDATA);
		return flag;
	}
	...
	public boolean LocationCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_LOCATIONCODE_COLDATA);
		return flag;
	}
	...
	public boolean LocationName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_LOCATIONNAME_COLDATA);
		return flag;
	}
	...
	public boolean LocationType_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_LOCATIONTYPE_COLDATA);
		return flag;
	}
	...
	public boolean City_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_CITY_COLDATA);
		return flag;
	}
	...
	public boolean State_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_STATE_COLDATA);
		return flag;
	}
	...
	public boolean Active_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_ACTIVE_COLDATA);
		return flag;
	}
	...
	public boolean SKUName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_SKUNAME_COLDATA);
		return flag;
	}
	...
	public boolean SKUNumber_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_SKUNUMBER_COLDATA);
		return flag;
	}
	...
	public boolean Stage_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_STAGE_COLDATA);
		return flag;
	}
	...
	public boolean Quantity_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_CurrentInventoryByLocationPageLocators.BY_QUANTITY_COLDATA);
		return flag;
	}
