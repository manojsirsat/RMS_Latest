...
public class Admin_WeekNumbersPageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Admin Week Numbers page
	...
	public boolean navigate_Admin_WeekNumbersListingPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.ADMIN_WEEKNUMBERSPAGE_LEFTNAV,
					ElementType.Xpath, Admin_WeekNumbersPageLocators.ADMIN_WEEKNUMBERSPAGE_HEADING, ElementType.Xpath);
		}
		return flag;
	}
	...
	public boolean LastUpdatedBy_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Admin_WeekNumbersPageLocators.BY_LASTUPDATEDBY_COLDATA);
		return flag;
	}
