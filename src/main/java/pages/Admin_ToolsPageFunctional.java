...
public class Admin_ToolsPageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Admin Tools page
	...
	public boolean navigate_Admin_ToolsListingPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.ADMIN_TOOLSPAGE_LEFTNAV,
					ElementType.Xpath, Admin_ToolsPageLocators.ADMIN_TOOLSPAGE_HEADING, ElementType.Xpath);
		}
		return flag;
	}
