...
public class Admin_ImportsPageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Admin Imports page
	...
	public boolean navigate_Admin_ImportsListingPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.ADMIN_IMPORTSPAGE_LEFTNAV,
					ElementType.Xpath, Admin_ImportsPageLocators.ADMIN_IMPORTSPAGE_HEADING, ElementType.Xpath);
		}
		return flag;
	}
