...
public class Reports_ArchivePageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Reports Archive page
	...
	public boolean navigate_Reports_ArchiveListingPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.REPORTS_ARCHIVEPAGE_LEFTNAV,
					ElementType.Xpath, Reports_ArchivePageLocators.REPORTS_ARCHIVEPAGE_HEADING, ElementType.Xpath);
		}
		return flag;
	}
