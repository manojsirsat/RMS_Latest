...
public class ReplenishmentsByComponentFunctional {
	...
	public boolean navigate_ComponentsListingPage() throws InterruptedException {
		flag = commonfunction.clickOnMainPage(CommonFunctionsLocators.PROFILENAME, ElementType.Xpath,
				CommonFunctionsLocators.REPLENISHMENTS_PAGE_LEFTNAV, ElementType.Xpath,
				CommonFunctionsLocators.REPLENISHMENTS_COMPONENTS_PAGE, ElementType.Xpath);
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.REPLENISHMENTS_COMPONENTS_PAGE,
					ElementType.Xpath, ReplenishmentsByComponentPageLocators.REPLENISHMENTSBYCOMPONENTSPAGE_HEADING,
					ElementType.Xpath);
		}
		return flag;
	}
	...
	public boolean ProviderLocCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_PROVIDERLOCCODE_COLDATA);
		return flag;
	}
	...
	public boolean ProviderLocName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_PROVIDERLOCNAME_COLDATA);
		return flag;
	}
	...
	public boolean Zone_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_ZONE_COLDATA);
		return flag;
	}
	...
	public boolean LocCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_LOCCODE_COLDATA);
		return flag;
	}
	...
	public boolean LocName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_LOCNAME_COLDATA);
		return flag;
	}
	...
	public boolean City_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_CITY_COLDATA);
		return flag;
	}
	...
	public boolean State_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_STATE_COLDATA);
		return flag;
	}
	...
	public boolean ZipCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_ZIPCODE_COLDATA);
		return flag;
	}
	...
	public boolean SKU_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_SKU_COLDATA);
		return flag;
	}
	...
	public boolean SKUName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_SKUNAME_COLDATA);
		return flag;
	}
	...
	public boolean ShipMin_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_SHIPMIN_COLDATA);
		return flag;
	}
	...
	public boolean ShipMax_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_SHIPMAX_COLDATA);
		return flag;
	}
	...
	public boolean InTransit_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_INTRANSIT_COLDATA);
		return flag;
	}
	...
	public boolean BelowMinQty_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_BELOWMINQTY_COLDATA);
		return flag;
	}
	...
	public boolean FG_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_FG_COLDATA);
		return flag;
	}
	...
	public boolean ConfAvail_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_CONFAVIL_COLDATA);
		return flag;
	}
	...
	public boolean Region_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_REGION_COLDATA);
		return flag;
	}
	...
	public boolean Account_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				ReplenishmentsByComponentPageLocators.BY_ACCOUNT_COLDATA);
		return flag;
	}
