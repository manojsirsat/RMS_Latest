...
public class Reports_OrderDetailsPageFunctional {
	...
	/**
	 * @author
	 * @return flag This method is used to navigate to Reports_OrderDetails page
	...
	public boolean navigate_Reports_OrderDetailsListingPage() throws InterruptedException {
		...
		if (flag) {
			flag = commonfunction.clickOnInternalPage(CommonFunctionsLocators.REPORTS_ORDERDETAILSPAGE_LEFTNAV,
					ElementType.Xpath, Reports_OrderDetailsPageLocators.REPORTS_ORDERDETAILSPAGE_HEADING,
					ElementType.Xpath);
		}
		return flag;
	}
	...
	public boolean OrderID_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_ORDERID_COLDATA);
		return flag;
	}
	...
	public boolean OrderStatus_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_ORDERSTATUS_COLDATA);
		return flag;
	}
	...
	public boolean BOLStatus_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_BOLSTATUS_COLDATA);
		return flag;
	}
	...
	public boolean OrderType_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_ORDERTYPE_COLDATA);
		return flag;
	}
	...
	public boolean Program_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_PROGRAM_COLDATA);
		return flag;
	}
	...
	public boolean CompletedWeek_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_COMPLETEDWEEK_COLDATA);
		return flag;
	}
	...
	public boolean PreBillingOverrideMinQuantity_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_PREBILLINGOVERRIDEMINQTY_COLDATA);
		return flag;
	}
	...
	public boolean PreBillingOverrideMinQuantityReason_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_PREBILLINGOVERRIDEMINQTYREASON_COLDATA);
		return flag;
	}
	...
	public boolean Customer_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_CUSTOMER_COLDATA);
		return flag;
	}
	...
	public boolean ItemSKU_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_ITEMSKU_COLDATA);
		return flag;
	}
	...
	public boolean ItemName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_ITEMNAME_COLDATA);
		return flag;
	}
	...
	public boolean ProgramOwner_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_PROGRAMOWNER_COLDATA);
		return flag;
	}
	...
	public boolean ShipMethod_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_SHIPMETHOD_COLDATA);
		return flag;
	}
	...
	public boolean ShipperLocRefCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_SHIPPERLOCREFCODE_COLDATA);
		return flag;
	}
	...
	public boolean ShipperLocName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_SHIPPERLOCNAME_COLDATA);
		return flag;
	}
	...
	public boolean FromLocCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_FROMLOCCODE_COLDATA);
		return flag;
	}
	...
	public boolean FromLocName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_FROMLOCNAME_COLDATA);
		return flag;
	}
	...
	public boolean FromLocAddress_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_FROMLOCADDRESS_COLDATA);
		return flag;
	}
	...
	public boolean FromLocCity_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_FROMLOCCITY_COLDATA);
		return flag;
	}
	...
	public boolean FromLocState_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_FROMLOCSTATE_COLDATA);
		return flag;
	}
	...
	public boolean FromLocZip_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_FROMLOCZIP_COLDATA);
		return flag;
	}
	...
	public boolean ToLocState_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_TOLOCSTATE_COLDATA);
		return flag;
	}
	...
	public boolean ToLocZip_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_TOLOCZIP_COLDATA);
		return flag;
	}
	...
	public boolean ToLocAddress_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_TOLOCADDRESS_COLDATA);
		return flag;
	}
	...
	public boolean ToLocCity_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_TOLOCCITY_COLDATA);
		return flag;
	}
	...
	public boolean ToLocCode_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_TOLOCCODE_COLDATA);
		return flag;
	}
	...
	public boolean ToLocName_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_TOLOCNAME_COLDATA);
		return flag;
	}
	...
	public boolean CustomerPO_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_CUSTOMERPO_COLDATA);
		return flag;
	}
	...
	public boolean OrderCreatedBy_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_ORDERCREATEDBY_COLDATA);
		return flag;
	}
	...
	public boolean AutoAssignEligible_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_AUTOASSIGNELIGIBLE_COLDATA);
		return flag;
	}
	...
	public boolean BatchFileID_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_BATCHFILEID_COLDATA);
		return flag;
	}
	...
	public boolean BatchFileNote_DecendingSorting() throws InterruptedException {
		commonfunction.validatePaginatedStringDecendingSorting(
				...
				Reports_OrderDetailsPageLocators.BY_BATCHFILENOTE_COLDATA);
		return flag;
	}
